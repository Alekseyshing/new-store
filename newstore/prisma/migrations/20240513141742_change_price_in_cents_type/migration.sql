/*
  ...
  - You are about to alter the column `pricePaidInCents` on the `Order` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
...
CREATE TABLE "new_Order" (
    ...
    "pricePaidInCents" BIGINT NOT NULL,
